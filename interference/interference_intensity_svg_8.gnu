# Plot inteference intensity of 8 source
...
E8(dq) = E0 * sin(wt + 7 * dq)

# resultants and intensities
Et(dq) = E1(dq) + E2(dq) + E3(dq) + E4(dq) \
+ E5(dq) + E6(dq) + E7(dq) + E8(dq)
I(dq) = Et(dq) * Et(dq)
...
set output "interference-pattern-slit-8.svg"
set yrange [0:64]
set ytics 16
